...
-- [回答]SELECT store_name 店舗名 FROM store_table
 
 
-- 2. 店舗情報を店舗名のABC順に抽出しなさい。
-- [回答]SELECT store_nameAbc FROM store_table ORDER BY store_nameAbc ASC
